...
<!-- saved from url=(0071)https://raw.github.com/meltingice/CamanJS/master/src/lib/filters.coffee -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;"># The filters define all of the built-in functionality that comes with Caman (as opposed to being 
